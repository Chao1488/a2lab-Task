	...
	<body>
		<header class="header home-page-header">
			<div class="container">
				...
				<nav class="navbar navbar-expand-xl toBottomAnimated" id="tenth"><a class="brand" href="/"><img class="d-inline-block align-top" src="<?php bloginfo('template_directory')?>/images/home-page-logo.png" alt="logo" style="width: 40px; height: 40px;"><span>VerumTrade</span></a>
