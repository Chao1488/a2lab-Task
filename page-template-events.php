...
*/
 ...
 <html>
 	<head>
 		...
 		<title>События - VerumTrade</title>
 		<meta name="description" content="События - VerumTrade"/>
 		<link rel="canonical" href="https://verumtrade.com/events.html"/>
 		<link rel="shortcut icon" href="<?php bloginfo('template_directory')?>/images/favicons/favicon_verum.ico">
 		<link rel="icon" type="<?php bloginfo('template_directory')?>/image/png" href="<?php bloginfo('template_directory')?>/images/favicons/favicon_verum.png" sizes="16x16">
 	...
 	<body>
 		...
 		<div class="events-page">
 			<div class="container">
 				<h6 class="pre-headline">Инфоцентр</h6>
 				<h1 class="page-headline ta-c">События VerumTrade</h1>
 				<div class="event-item">
 					<div class="photo-block"><img src="<?php bloginfo('template_directory')?>/images/event-photo.png" alt="Event photo"></div>
 					<div class="info-block">
 						<div class="line-1"><span class="event-type">Конференция</span><span class="is-free">Вход свободный</span></div>
 						<div class="line-2">
 						...
 						<div class="line-3">
 							<div class="headline">Большое событие для больших людей</div>
 						</div>
 						<div class="line-4">
 							<div class="address"><i class="zmdi zmdi-pin"></i><span>Киев. Отель Tien Shan, ул.Богенбай Батыра 115</span></div>
 						</div>
 						<div class="line-5"><a class="photo-btn" href="#lightbox1" data-toggle="modal"><i class="zmdi zmdi-camera"></i><span>Фотографии</span></a><a class="video-btn" href="#lightbox2" data-toggle="modal"><i class="zmdi zmdi-videocam"></i><span>Видеоотчет</span></a></div>
 					</div>
 				</div>
 				<div class="event-item">
 					<div class="photo-block"><img src="<?php bloginfo('template_directory')?>/images/event-photo.png" alt="Event photo"></div>
 					<div class="info-block">
 						...
 						<div class="line-5"><a class="photo-btn" href="#lightbox3" data-toggle="modal"><i class="zmdi zmdi-camera"></i><span>Фотографии</span></a><a class="video-btn" href="#lightbox4" data-toggle="modal"><i class="zmdi zmdi-videocam"></i><span>Видеоотчет</span></a></div>
 					</div>
 				</div>
 				<div class="event-item">
 					<div class="photo-block"><img src="<?php bloginfo('template_directory')?>/images/event-photo.png" alt="Event photo"></div>
 					<div class="info-block">
 						...
 						<div class="line-5"><a class="photo-btn" href="#lightbox5" data-toggle="modal"><i class="zmdi zmdi-camera"></i><span>Фотографии</span></a><a class="video-btn" href="#lightbox6" data-toggle="modal"><i class="zmdi zmdi-videocam"></i><span>Видеоотчет</span></a></div>
 					</div>
 				</div>
 			</div>
